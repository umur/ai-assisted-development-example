# CinéTrack — Chapter 28 Snapshot

Snapshot of CinéTrack at the end of Chapter 28: *When to Trust the Agent — and When Not To*.

## What changed in this chapter

No Java source changes. All application code and CI configuration carried forward from Chapter 27.

Chapter 28 is a judgment chapter: understanding why AI confidence doesn't signal accuracy, how to map task types to trust levels, and how to build personal calibration over time. The CinéTrack CLAUDE.md already encodes the project's trust boundaries; this chapter explains why those entries exist.
