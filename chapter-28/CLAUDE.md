...
- Default interactive sessions: Claude Sonnet
- Security reviews, ADRs, architecture planning: switch to Opus before starting
- CI/CD agents: pin model explicitly in workflow config, cap output at 2,048 tokens
- Run /compact after completing each major feature
