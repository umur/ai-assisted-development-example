# CinéTrack — Chapter 26 Snapshot

Snapshot of CinéTrack at the end of Chapter 26: *Cost, Latency, and Model Selection*.

## What changed in this chapter

No Java source changes. All application code carried forward from Chapter 25.

Chapter 26 covers the economics of AI API usage: token pricing, input vs output cost differential, context trimming, model tier selection, and how to configure model choices in Claude Code and CI/CD pipelines.
