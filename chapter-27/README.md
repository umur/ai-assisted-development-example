# CinéTrack — Chapter 27 Snapshot

Snapshot of CinéTrack at the end of Chapter 27: *AI in CI/CD: Agents in Pull Request Pipelines*.

## What changed in this chapter

No Java source changes. All application code carried forward from Chapter 26.

- **`.github/workflows/ai-review.yml`** — GitHub Actions workflow that runs an AI convention check on every pull request, posts findings as an advisory comment, and skips PRs with no Java changes
